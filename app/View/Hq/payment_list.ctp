	 ...
	 <?php echo $this->Session->flash();?> 
	    ...
	    <div class="row padding_btm_20">
		 <div class="col-lg-3">		     
                   ...
                   <?php echo $this->Html->link('Download Excel', array('controller'=>'hq','action'=>'paymentListDownload'),array('class' => 'btn btn-default')); ?>
...
<!--			<td><?php //echo  $data['MerchantPayment']['id']  ; ?></td>-->
			...
			<td><?php echo  $this->Dateform->us_format($data['MerchantPayment']['payment_date'])  ; ?></td>
