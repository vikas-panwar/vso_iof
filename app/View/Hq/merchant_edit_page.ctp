...
<div class="row">        
    ...
    <div class="col-lg-6">            
        <div class="form-group form_margin">		 
            ...
            <?php
            echo $this->Form->input('MerchantContent.name', array('type' => 'text', 'class' => 'form-control valid', 'placeholder' => 'Enter Type', 'label' => '', 'div' => false));
            echo $this->Form->error('MerchantContent.name');
            echo $this->Form->input('MerchantContent.id', array('type' => 'hidden'));
            ?>
        </div>
<!--        <div class="form-group form_margin">		 
            <label>Content Key<span class="required"> * </span></label>               

            <?php echo $this->Form->input('MerchantContent.content_key', array('type' => 'text', 'class' => 'form-control valid', 'placeholder' => 'Enter Type', 'label' => '', 'div' => false));
...
<script>
    $(document).ready(function () {
        $("#MerchantContentMerchantEditPageForm").validate({
            rules: {
