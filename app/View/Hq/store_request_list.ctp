...
<div class="row">
	 ...
	 <?php
	    ...
	    <?php echo $this->Form->create('hqs', array('url' => array('controller' => 'hq', 'action' => 'storeRequestList'),'id'=>'AdminId','type'=>'get'));  ?>
...
<script>
    $(document).ready(function () {
        $("#hqKeyword").autocomplete({
           source: "/hq/getMerchantStoreNames",
            minLength: 3,
