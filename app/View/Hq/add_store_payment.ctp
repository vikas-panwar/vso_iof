...
<div class="row">        
    ...
    <div class="col-lg-6">
        ...
        <div class="form-group form_margin hidden store-payment-date">
            <label>Payment Date<span class="required"> * </span></label>  
            <?php
            echo $this->Form->input('StorePayment.payment_date', array('type' => 'text', 'class' => 'form-control', 'div' => false, 'readonly' => true, 'Placeholder' => 'Select Payment Date'));
        ...
        <div class="form-group form_margin">		 
            ...
            <?php
            echo $this->Form->input('StorePayment.amount', array('type' => 'text', 'class' => 'form-control valid serialize', 'label' => false, 'div' => false, 'Placeholder' => 'Enter Amount', 'autocomplete' => 'off'));
    ...
    <?php echo $this->Html->link('Cancel', "/hq/storePaymentList/", array("class" => "btn btn-default", 'escape' => false)); ?>
    </div>
