    ...
    <div class="row">        
	   ...
	   <div class="form-group form_margin">		 
		...
		<?php echo $this->Form->input('SocialMedia.facebook',array('type'=>'text','class'=>'form-control valid','placeholder'=>'Facebook','label'=>'','div'=>false));
		...
		<?php echo $this->Form->input('SocialMedia.twitter',array('type'=>'text','class'=>'form-control valid','placeholder'=>'Twitter','label'=>'','div'=>false));
                  echo $this->Form->error('SocialMedia.twitter'); ?>
            </div>
	      <div class="form-group form_margin">		 
                <label>Instagram</label>               
              
		<?php echo $this->Form->input('SocialMedia.instagram',array('type'=>'text','class'=>'form-control valid','placeholder'=>'Instagram','label'=>'','div'=>false));
                  echo $this->Form->error('SocialMedia.instagram'); ?>
            </div>
	        <div class="form-group form_margin">		 
                <label>Pinterest</label>               
              
		<?php echo $this->Form->input('SocialMedia.pinterest',array('type'=>'text','class'=>'form-control valid','placeholder'=>'Pinterest','label'=>'','div'=>false));
                  echo $this->Form->error('SocialMedia.pinterest'); ?>
            </div>
		  <div class="form-group form_margin">		 
                <label>Yelp</label>               
              
		<?php echo $this->Form->input('SocialMedia.yolo',array('type'=>'text','class'=>'form-control valid','placeholder'=>'Yelp','label'=>'','div'=>false));
                  echo $this->Form->error('SocialMedia.yolo'); ?>
            </div>
		    <div class="form-group form_margin">		 
                <label>Google</label>               
              
		<?php echo $this->Form->input('SocialMedia.google',array('type'=>'text','class'=>'form-control valid','placeholder'=>'Google','label'=>'','div'=>false));
                  echo $this->Form->error('SocialMedia.google'); ?>
            </div>
		      <div class="form-group form_margin">		 
                <label>Yahoo</label>               
              
		<?php echo $this->Form->input('SocialMedia.yahoo',array('type'=>'text','class'=>'form-control valid','placeholder'=>'Yahoo','label'=>'','div'=>false));
                  echo $this->Form->error('SocialMedia.yahoo'); ?>
            </div>
	     <div class="form-group form_margin">		 
                <label>Yellow Page</label>               
              
		<?php echo $this->Form->input('SocialMedia.yellow_page',array('type'=>'text','class'=>'form-control valid','placeholder'=>'Yellow Page','label'=>'','div'=>false));
		...
		<?php echo $this->Form->input('SocialMedia.try_caviar',array('type'=>'text','class'=>'form-control valid','placeholder'=>'Try Caviar','label'=>'','div'=>false));
		...
		<?php echo $this->Form->input('SocialMedia.home',array('type'=>'text','class'=>'form-control valid','placeholder'=>'Home','label'=>'','div'=>false));
                  echo $this->Form->error('SocialMedia.home'); ?>
            </div>
