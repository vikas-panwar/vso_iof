    ...
    <div class="row">        
		...
		<?php echo $this->Form->input('User.fname',array('type'=>'text','class'=>'form-control','placeholder'=>'Enter Your First Name','div'=>false));
                  echo $this->Form->error('User.fname');?>
            </div>
	     <div class="form-group form_margin">
                <label>Last Name</label>                
              
		<?php echo $this->Form->input('User.lname',array('type'=>'text','class'=>'form-control','placeholder'=>'Enter Your Last Name','div'=>false));
                  echo $this->Form->error('User.lname');?>
            </div>
	     <div class="form-group form_margin">
                <label>Email</label>                
              
		<?php echo $this->Form->input('User.email',array('type'=>'text','class'=>'form-control email','placeholder'=>'Enter Your Email','div'=>false,'readonly'=>true));
		...
		<?php echo $this->Form->input('User.changepassword',array('type'=>'checkbox','class'=>'passwrd-input','placeholder'=>'Date of Birth','label'=>'Change Password'));?>
