<div class="row">
    <div class="col-lg-12">
        ...
        <div class="table-responsive">   
            <?php echo $this->Form->create('Store', array('url' => array('controller' => 'Stores', 'action' => 'staffList'), 'id' => 'AdminId', 'type' => 'get')); ?>
            <div class="row padding_btm_20">
                ...
                <div class="col-lg-4">                        
                    ...
                    <?php echo $this->Html->link('Clear', array('controller' => 'Stores', 'action' => 'staffList'), array('class' => 'btn btn-default')); ?>
                </div>
<!--                <div class="col-lg-4">    
                    <div class="addbutton">                
