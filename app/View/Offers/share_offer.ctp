...
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="table-responsive">
            ...
            <?php echo $this->Form->create('Offer', array('url' => array('controller' => 'offers', 'action' => 'shareOffer'), 'id' => 'AdminId', 'type' => 'post')); ?>

            <?php echo $this->Form->input('User.offer_id', array('type' => 'hidden', 'value' => $offerId)); ?>
