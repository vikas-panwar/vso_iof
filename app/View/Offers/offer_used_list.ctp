    ...
    <div class="col-lg-12">
        ...
        <div class="table-responsive">
            ...
            <table class="table table-bordered table-hover table-striped tablesorter">
                <thead>
                    <tr>
                        <th  class="th_checkbox">Offer Description<?php //echo $this->Paginator->sort('Offer.description', 'Offer Description'); ?></th>
                        <th  class="th_checkbox">Item Name<?php //echo $this->Paginator->sort('Item.name', 'Item Name'); ?></th>
                        <th  class="th_checkbox">Count</th>
                        <th  class="th_checkbox">User Name<?php //echo $this->Paginator->sort('Order.User.userName', 'User Name'); ?></th>
                        <th  class="th_checkbox">Email<?php //echo $this->Paginator->sort('Order.User.email', 'Email'); ?></th>
                </thead>
