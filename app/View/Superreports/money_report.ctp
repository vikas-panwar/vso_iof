...
$amntdate = ''; $amnt = '' ; $tamnt = 0 ;
    if($type == 1){       
       echo $this->element('/superreport/dollar/daily');
    }elseif($type == 2){
        //echo "In progress";
       echo $this->element('/superreport/dollar/weekly'); 
    }elseif($type == 3){
       echo $this->element('/superreport/dollar/monthly'); 
    }elseif($type == 4){
       echo $this->element('/superreport/dollar/yearly'); 
    }elseif($type == 5){
       echo $this->element('/superreport/dollar/life_time'); 
    } 
...
<div class="row">
    ...
    <div class="col-lg-12">
        ...
        <?php echo $this->Form->create('Report', array('url' => array('controller' => 'superreports', 'action' => 'moneyReport','id'=>'AdminId')));  ?>
	...
	<?php echo $this->Form->input('Segment.id',array('type'=>'select','class'=>'form-control valid','label'=>false,'div'=>false,'autocomplete' => 'off','options'=>$typeList,'empty'=>'Order Type')); ?>		
                ...
                <div class="col-lg-1">	
                    ...
                    <?php
		    if(!empty($storeId)){
		    echo $this->Html->link('Download Excel', array('controller'=>'superreports','action'=>'moneyReportDownload',$storeId,$type,$startdate,$enddate,$Month,$Year,$yearFrom,$yearTo,$ordertype),array('class' => 'btn btn-default'));
		    }else{
		     echo $this->Html->link('Download Excel', array('controller'=>'superreports','action'=>'moneysecondReportDownload',$type,$startdate,$enddate,$Month,$Year,$yearFrom,$yearTo,$ordertype),array('class' => 'btn btn-default'));
	  ...
	  echo  $this->element('superreport/dollar/index') ;
