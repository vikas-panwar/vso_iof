...
$amntdate = ''; $amnt = '' ; $tamnt = 0 ;
    if($type == 1){       
       echo $this->element('/superreport/product/daily');
    }elseif($type == 2){
        //echo "In progress";
       echo $this->element('/superreport/product/weekly'); 
    }elseif($type == 3){
       echo $this->element('/superreport/product/monthly'); 
    }elseif($type == 4){
       echo $this->element('/superreport/product/yearly'); 
    }elseif($type == 5){
       echo $this->element('/superreport/product/life_time'); 
    } 
...
<div class="row">
    <div class="col-lg-12">
        ...
        <?php echo $this->Form->create('Report', array('url' => array('controller' => 'superreports', 'action' => 'productReport','id'=>'one')));  ?>
	...
	<?php echo $this->Form->input('Item.id',array('type'=>'select','class'=>'form-control valid','label'=>false,'div'=>false,'autocomplete' => 'off','options'=>$categoryList,'empty'=>'Item name')); ?>		
		    ...
		    echo $this->Html->link('Download Excel', array('controller'=>'superreports','action'=>'productReportDownload',$storeId,$type,$startdate,$enddate,$Month,$Year,$yearFrom,$yearTo,$item),array('class' => 'btn btn-default'));
		     }else{
			
		     echo $this->Html->link('Download Excel', array('controller'=>'superreports','action'=>'superproductReportDownload',$type,$startdate,$enddate,$Month,$Year,$yearFrom,$yearTo,$item),array('class' => 'btn btn-default'));
	  ...
	  echo  $this->element('superreport/product/index') ;
...
$(document).ready(function(){
    $('#StoreId').on('change', function () {
            ...
            $.ajax({
                ...
                complete: function () {
                     $("#ReportProductReportForm").submit();
                }
            });
