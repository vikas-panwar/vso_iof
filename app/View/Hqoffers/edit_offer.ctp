...
<div class="row">        
    ...
    <div class="col-lg-6">
        <div class="form-group">
            ...
            if (!empty($this->request->data['Offer']['store_id'])) {
                $store_id = $this->request->data['Offer']['store_id'];
            }
            echo $this->Form->input('Offer.store_id', array('options' => @$merchantList, 'class' => 'form-control', 'label' => false, 'div' => false, 'empty' => 'Please Select Store', 'disabled' => true));
            ?>
        </div>
        <div class="form-group">		 
            ...
            echo $this->Form->input('Offer.store_id', array('type' => 'hidden', 'label' => false, 'div' => false));
        ...
        <div class="form-group">		 
            ...
            <?php echo $this->Form->input('Offered.id', array('type' => 'select', 'class' => 'form-control valid serialize multiOnly', 'label' => false, 'div' => false, 'autocomplete' => 'off', 'options' => $itemList, 'empty' => 'Select Item', 'multiple' => true)); ?>
            ...
            if (isset($this->request->data['OfferDetails']) && $this->request->data['OfferDetails']) {
                foreach ($this->request->data['OfferDetails'] as $key => $details) {
                    ...
                    if ($details['offerSize']) {
                        $Sizesoptions = $this->Common->getItemSize($details['item_id'], $this->request->data['Offer']['store_id']);
                        echo $this->Form->input('OfferDetails.' . $key . '.offerSize', array('type' => 'select', 'class' => 'form-control valid serialize priceVal', 'label' => '', 'div' => false, 'autocomplete' => 'off', 'options' => $Sizesoptions, 'label' => 'Size', 'value' => $details['offerSize']));
                    }
        ...
        <div class="form-group clearfix">
            ...
            <div style="float:right;">
                ...
                if ($this->request->data['Offer']['imgcat']) {
                    echo $this->Html->image('/Offer-Image/thumb/' . $this->request->data['Offer']['imgcat'], array('alt' => 'Item Image', 'height' => 150, 'width' => 150, 'style' => 'border:1px solid #000000;margin:5px 0px 5px 5px;', 'title' => 'Offer Image'));
                    echo $this->Html->link("X", array('controller' => 'hqoffers', 'action' => 'deleteOfferPhoto', $EncryptOfferID), array('confirm' => 'Are you sure to delete Offer Photo?', 'title' => 'Delete Photo', 'style' => 'vertical-align:top;margin-right:10px;font-size:18px;font-weight:bold;'));
                }
                ?>
            </div>	
        </div>
        ...
        <div class="form-group">
            ...
            <?php
            echo $this->Form->input('Offer.offer_start_date', array('type' => 'text', 'class' => 'form-control', 'div' => false));
            ?>
...
//	});
        ...
        $('#ItemPricePrice,#OfferOfferprice,.priceVal').keyup(function () {
