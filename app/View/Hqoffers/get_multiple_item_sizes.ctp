...
//                    }
                    ...
                    echo $this->Form->input('OfferDetails.' . $itemkey . '.discountAmt', array('type' => 'text', 'class' => 'form-control valid serialize priceVal', 'placeholder' => 'Enter Price', 'label' => 'Price', 'div' => false, 'value' => $existingOfferdetails['discountAmt']));
...
//                    }
                    ...
                    echo $this->Form->input('OfferDetails.' . $itemkey . '.discountAmt', array('type' => 'text', 'class' => 'form-control valid serialize priceVal', 'placeholder' => 'Enter Price', 'label' => 'Price', 'div' => false));
                    echo '<span class="blue">(Enter price for item if applicable)</span>';
                }
            }
        } else {
