<div class="row">
    ...
    <div class="row">        
		     ...
		     <div class="form-group form_spacing">
                <?php
                    echo $this->Form->create('Store',array('url'=>array('controller'=>'hqsettings','action'=>'addClosedDate'),'inputDefaults' => array('label' => false, 'div'=>false, 'required' => false, 'error' => false, 'legend' => false,'autocomplete' => 'off'),'id'=>'storeclosed'));
                ?>
		   ...
		   <?php } ?>
            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered table-hover table-striped tablesorter">
                    ...
                    <tbody class="dyntable">                       
                          <tr>
                            ...
                            ?>
                            <td><?php echo $this->Form->input('StoreAvailability.'.$key.'.start_time',array('options'=>$timeOptions,'value'=>$data['StoreAvailability']['start_time'],'class'=>'passwrd-input ','div'=>false));?></td>
                            ...
                            <?php 
                             ...
                             ?>
                             <td><?php echo $this->Form->input('StoreAvailability.'.$i.'.start_time',array('options'=>$timeOptions,'class'=>'passwrd-input ','div'=>false));?></td>
                          ...
                          <tr>
                             ...
                             if(!empty($availabilityInfo)){
                                foreach($availabilityInfo as $key => $data){
                            ?>
                            <td><?php echo $this->Form->input('StoreAvailability.'.$key.'.end_time',array('options'=>$timeOptions,'value'=>$data['StoreAvailability']['end_time'],'class'=>'passwrd-input ','div'=>false));?></td>                           
                ...
                <?php if($StoreBreak){ $display="";}else{$display="style='display:none;'";}?>
                <div class="col-lg-11" id="Breaksection" <?php echo $display;?>>   
                    <div class="table-responsive">
                        <span class="blue">(Please enter Break Time Day wise)</span> 
                        <?php
                        echo $this->Form->create('Stores', array('inputDefaults' => array('label' => false, 'div'=>false, 'required' => false, 'error' => false, 'legend' => false,'autocomplete' => 'off'),'id'=>'storeBreakTime','action'=>'breakTimeUpdates'));
                        ...
                        <table class="table table-bordered table-hover table-striped tablesorter">
                           ...
                           <tbody class="dyntable">
                                  ...
                                  <?php if($StoreBreak1){ $display="";}else{$display="style='display:none;'";}?>
                                  ...
                                  <tr class="firstBreak" <?php echo $display;?>>
                                   ...
                                   <?php 
                                         }else{ echo "<td><span class='red'>Closed</span></td>"; }
                                           echo $this->Form->input('StoreBreak.'.$key.'.id',array('type'=>'hidden','value'=>$data['StoreBreak']['id']));
                                           echo $this->Form->input('StoreBreak.'.$key.'.store_availablity_id',array('type'=>'hidden','value'=>$data['StoreAvailability']['id']));
                                ...
                                <?php if($StoreBreak2){ $display="";}else{$display="style='display:none;'";}?>
