                            ...
                            <tr <?php echo $class; ?> notif-id="<?php echo $EncryptFeaturedID; ?>">	    
                                ...
                                <td>
                                    ...
                                    if ($data['StoreFeaturedSection']['is_active']) {
                                        echo $this->Html->link($this->Html->image("store_admin/active.png", array("alt" => "Active", "title" => "Active")), array('controller' => 'features', 'action' => 'activateFeature', $EncryptFeaturedID, 0), array('confirm' => 'Are you sure to Deactivate this feature?', 'escape' => false));
                                    } else {
                                        echo $this->Html->link($this->Html->image("store_admin/inactive.png", array("alt" => "Inactive", "title" => "Inactive")), array('controller' => 'features', 'action' => 'activateFeature', $EncryptFeaturedID, 1), array('confirm' => 'Are you sure to Activate this feature?', 'escape' => false));
                                    }
                                    ?>
                                </td>
                                <td class='sort_order'>		
                                    <?php echo $this->Html->link($this->Html->image("store_admin/edit.png", array("alt" => "Edit", "title" => "Edit")), array('controller' => 'features', 'action' => 'edit_features', $EncryptFeaturedID), array('escape' => false)); ?>
                                    | <?php
...
<script type="text/javascript">
    ...
    function updateOrder() {
        ...
        if (orderData) {
            $.ajax({
                url: '/features/updateFeaturePosition?' + orderData,
                type: 'get',
                success: function () {
                }
            });
