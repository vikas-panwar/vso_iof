...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="table-responsive">   
            <?php echo $this->Form->create('ItemPrice', array('url' => array('controller' => 'hqsizes', 'action' => 'sizelisting'), 'id' => 'AdminId', 'type' => 'post')); ?>
            <div class="row">
                <div class="col-lg-3">
                    <?php
                    $merchantList = $this->Common->getHQStores($this->Session->read('merchantId'));
                    echo $this->Form->input('ItemPrice.store_id', array('options' => @$merchantList, 'class' => 'form-control', 'label' => false, 'div' => false, 'empty' => 'All Store'));
                    ?>
                </div>
                ...
                <div class="col-lg-2">		     
                    ...
                    echo $this->Form->input('ItemPrice.is_active', array('type' => 'select', 'class' => 'form-control valid', 'label' => false, 'div' => false, 'autocomplete' => 'off', 'options' => $options, 'empty' => 'Select Status'));
                    ?>		
                </div>
                <div class="col-lg-2">
                ...
                <div class="col-lg-1">
                    <?php echo $this->Html->link('Clear', "/hqsizes/sizelisting/clear", array("class" => "btn btn-default", 'escape' => false)); ?>
                </div>
                            ...
                            <tr <?php echo $class; ?> notif-id="<?php echo $EncryptTypeID; ?>" >
                                ...
                                <td>
                                    ...
                                    if ($data['ItemPrice']['is_active']) {
                                        echo $this->Html->link($this->Html->image("store_admin/active.png", array("alt" => "Active", "title" => "Active")), array('controller' => 'hqsizes', 'action' => 'activateItemSize', $EncryptTypeID, 0), array('confirm' => 'Are you sure to Deactivate Size?', 'escape' => false));
                                    } else {
                                        echo $this->Html->link($this->Html->image("store_admin/inactive.png", array("alt" => "Inactive", "title" => "Inactive")), array('controller' => 'hqsizes', 'action' => 'activateItemSize', $EncryptTypeID, 1), array('confirm' => 'Are you sure to Activate Size?', 'escape' => false));
                                    }
                                    ?>
                                </td>
                                <?php if (!empty($this->request->data['ItemPrice']['item_id'])) { ?>
...
//echo $this->Form->button('Delete Preference', array('type' => 'submit','class' => 'btn btn-default','onclick'=>'return check();'));           
        ...
        <script>
            $(document).ready(function () {
                var storeId=$('#ItemPriceStoreId').val();
                $("#SizeSearch").autocomplete({
                     source: "/hqsizes/getItemSizeList?storeID="+storeId,
                    minLength: 3,
                ...
                $("#ItemPriceItemId,#ItemPriceStoreId").change(function () {
