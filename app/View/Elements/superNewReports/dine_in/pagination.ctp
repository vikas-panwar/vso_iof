    ...
    <div class="col-lg-12">
		...
		?>
                <tr>
                    ...
                    <th  class="th_checkbox"><?php echo $this->Paginator->sort('Booking.number_person', 'No. of Person',array('url'=>@$url));?></th>
                    ...
                    <th  class="th_checkbox"><?php echo $this->Paginator->sort('Booking.created', 'Created',array('url'=>@$url));?></th>
                </tr>
            </thead>
