    ...
    <span class="payoptioncls">
        <?php if (AuthComponent::User() || ($store_result['Store']['guest_user'] == 1 && $store_result['Store']['guest_user_cod'] == 1)) { ?>
            ...
            if ($store_result['Store']['cash_on_delivery'] == 1) {
                ...
                ?>
                <input type="radio" id='payment2' name="payment" value=3 class="cod" <?php echo $checked; ?>/> <label for="payment2" class="common-bold" id="pcodLabel"><span></span>Cash on Delivery</label>
            <?php } ?>
        <?php } ?>
    </span>
    <span class="payoptioncls">
        ...
        if ($store_result['Store']['is_express_check_out'] == 1 && $store_result['Store']['paypal_email'] != '' && $store_result['Store']['paypal_password'] != '' && $store_result['Store']['paypal_signature'] != '' && !empty($storeSetting['StoreSetting']['paypal_allow']) && $finalAmount > 0) {
            ...
            ?>
            <input type="radio" id='express-check-out' name="payment" value=2 class="express-check-out" <?php echo $checked; ?>/> <label for="express-check-out" class="common-bold" id="pexpcLabel"><span></span>PayPal Express</label>
        <?php } ?>
    </span>              
</div>
