...
<div class="main-container review-page">
    ...
    <div class="inner-wrap profile">
        ...
        <div class="common-title custom-title-wrap clearfix">
            <div class="row">
                <div class="col-md-3 col-sm-3 col-xs-4 pull-right">
                    <a href="javascript:void(0);" class="addReviews pull-right srch-btn theme-bg-1"><?php echo __('Add Reviews'); ?></a>
                </div>
            </div>
        </div>
        ...
        if (extn == "png" || extn == "jpg" || extn == "jpeg") {
            if (typeof (FileReader) != "undefined") {
                ...
                for (var i = 0; i < countFiles; i++) {
                    ...
                    image_holder.append('<span title="Remove" class="removeImage"><b>&times;</b></span> <span>' + $(this)[0].files[i].name + '</span>');
                    image_holder.show();
