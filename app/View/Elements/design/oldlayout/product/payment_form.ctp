...
<input id="designType" type="hidden" value="<?php echo DESIGN; ?>"/>
...
<div class="radio-btn space20 delivery-address-option payoptioncls">
    <?php if ($store_result['Store']['is_pay_by_credit_card'] == 1 && $store_result['Store']['api_username'] != '' && $store_result['Store']['api_password'] != '' && !empty($storeSetting['StoreSetting']['is_creditcard_allow']) && $finalAmount > 0) { ?>
        <input type="radio" id='payment' name="payment" checked="checked" value=1 class="credit" /><label for="payment" class="common-bold" id="pccLabel"><span></span>Pay by Credit Card</label>
    <?php } ?>
    ...
    <?php if (AuthComponent::User() || ($store_result['Store']['guest_user'] == 1 && $store_result['Store']['guest_user_cod'] == 1)) { ?>
        <?php if ($store_result['Store']['cash_on_delivery'] == 1) { ?>
            <input type="radio" id='payment2' name="payment" value=3 class="cod" /> <label for="payment2" class="common-bold" id="pcodLabel"><span></span>Cash on Delivery</label>
        <?php } ?>
    <?php } ?>
    ...
    <?php if ($store_result['Store']['is_express_check_out'] == 1 && $store_result['Store']['paypal_email'] != '' && $store_result['Store']['paypal_password'] != '' && $store_result['Store']['paypal_signature'] != '' && !empty($storeSetting['StoreSetting']['paypal_allow']) && $finalAmount > 0) { ?>
        <input type="radio" id='express-check-out' name="payment" value=2 class="express-check-out" /> <label for="express-check-out" class="common-bold" id="pexpcLabel"><span></span>PayPal Express</label>
    <?php } ?>
...
<?php if ($finalAmount > 0 && $store_result['Store']['is_pay_by_credit_card'] == 1 && $store_result['Store']['api_username'] != '' && $store_result['Store']['api_password'] != '') { ?>
