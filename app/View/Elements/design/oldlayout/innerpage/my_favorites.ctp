...
<!--                                                <a class='share_button' 
                                    ...
                                    <div class="order-history-detail-lt">
                                        <p> <span><?php echo __('Order Id:');?> <?php echo $orders['Order']['order_number'];?></span><span class="seprator-bar">|</span><span><?php echo __('Cost:');?> $<?php echo $orders['Order']['amount'];?> <?php echo ' - '.$orders['Order']['OrderStatus']['name'];?></span> </p>
