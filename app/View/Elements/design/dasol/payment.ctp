...
if (!empty($userId) || !empty($guestUserDetail)) {
    ...
    <?php if ($finalAmount > 0) { ?>
        ...
        <div class="pay-option check-out-option">
            ...
            <div class="card-detail pay-date-d" id='credit_payment1'>
            ...
            <div class="card-detail pay-date-d" id='credit_payment2'>                        
                <div class="card-input">
...
<div class="continue">
    ...
    if ((!empty($userId) || !empty($guestUserDetail))) {
        ...
        <div id="paypal-express-btn" style="display: none">
            ...
            <?php
            echo $this->Html->link('PAYMENT', array('controller' => 'payments', 'action' => 'express_checkout'), array('class' => 'btn save-order theme-bg-1'));
            ?>
        ...
        <div id="pay-credit-card">
            <!-- ===== Express check-out Payment Button ===== -->
            <?php
            echo $this->Form->button('PAYMENT', array('class' => 'changeName btn save-order theme-bg-1'));
            ?>
            <!-- ===== Express check-out Payment Button End===== -->
        </div>
    <?php } ?>
