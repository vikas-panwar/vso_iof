...
echo $this->Session->flash();
            ...
            echo $this->Form->input('Orders.id',array('type'=>'hidden','value'=>$orderDetail['Order']['id']));
            echo $this->Form->input('Orders.store_id',array('type'=>'hidden','value'=>$orderDetail['Order']['store_id']));
