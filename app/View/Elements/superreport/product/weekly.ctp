                ...
                ?>
                {
                    ...
                    drilldown: {                        
                        ...
                        foreach($graphdata['daywise'] as $key => $innerGraphdata){
                                if($coloumstring==''){
                                    $coloumstring.=(isset($innerGraphdata['item_count']))?$innerGraphdata['item_count']:0;
                                }else{
                                    $coloumstring.=",";    
                                    $coloumstring.=(isset($innerGraphdata['item_count']))?$innerGraphdata['item_count']:0;
                                }
                                ...
                                if(isset($innerGraphdata['item_count'])){
                                        if($amountmax < $innerGraphdata['item_count']){
                                               $amountmax = $innerGraphdata['item_count'];
                                        }
                                }
