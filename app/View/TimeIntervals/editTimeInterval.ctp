    ...
    <div class="row">        
		...
		<?php
            ...
            <div class="form-group form_margin">		 
                ...
                <?php echo $this->Form->input('Offer.unit',array('min'=>'1','type'=>'number','class'=>'form-control valid','placeholder'=>'Number of units','label'=>'','div'=>false));
	    ...
	    <div class="form-group form_margin">
            ...
            <?php if($istimeRestriction){ $display="style='display:block;'";}else{$display="style='display:none;'";}?>
