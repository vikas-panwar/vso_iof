...
<script type="text/javascript">
    ...
    function fetchPaginationData(page = null, sort = null, sort_direction = null) 
    {
        ...
        $.ajax({
            ...
            data: {reportType: reportType, orderType: orderType, customerType: customerType, type: type, storeId: storeId, merchantOption: merchantOption, itemId: itemId, startDate: startDate, endDate: endDate, fromMonth: fromMonth, fromYear: fromYear, toMonth: toMonth, toYear: toYear, coupon_code: coupon_code, promo_id: promo_id, extended_offer_id: extended_offer_id, product_count: product_count, page: page, sort: sort, sort_direction: sort_direction},
            success: function (result) {
    ...
    function fetchGraphPaginationData(graph_page_number = null) {
        ...
        $.ajax({
            ...
            data: {reportType: reportType, orderType: orderType, customerType: customerType, type: type, storeId: storeId, merchantOption: merchantOption, itemId: itemId, startDate: startDate, endDate: endDate, fromMonth: fromMonth, fromYear: fromYear, toMonth: toMonth, toYear: toYear, coupon_code: coupon_code, promo_id: promo_id, extended_offer_id: extended_offer_id, product_count: product_count, graph_page_number: graph_page_number},
            success: function (result) {
                $("#showchart").html(result);
                $('#loading').addClass('hidden');
            }
