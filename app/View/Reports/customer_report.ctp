...
$amntdate = ''; $amnt = '' ; $tamnt = 0 ;
    if($type == 1){       
       echo $this->element('/report/customer/daily');
    }elseif($type == 2){
        //echo "In progress";
       echo $this->element('/report/customer/weekly'); 
    }elseif($type == 3){
       echo $this->element('/report/customer/monthly'); 
    }elseif($type == 4){
       echo $this->element('/report/customer/yearly'); 
    }elseif($type == 5){
       echo $this->element('/report/customer/life_time'); 
    } 
...
<div class="row">
    <div class="col-lg-12">
        ...
        <?php echo $this->Form->create('Report', array('url' => array('controller' => 'reports', 'action' => 'customerReport','id'=>'one')));  ?>
	    <div class="row padding_btm_20">
		    ...
		    echo $this->Form->input('type',array('id'=>'DataType','type'=>'select','class'=>'form-control valid','label'=>false,'div'=>false,'options'=>$options)); ?>		
                ...
                <div class="col-lg-1">	
                    <label>&nbsp;&nbsp;&nbsp;&nbsp;</label>
                    <?php echo $this->Html->link('Download Excel', array('controller'=>'reports','action'=>'customerReportDownload',$type,$startdate,$enddate,$Month,$Year,$yearFrom,$yearTo),array('class' => 'btn btn-default')); ?>
                </div>
           </div></div>
        <?php echo $this->Form->end();?>
          ...
          <?php  echo  $this->element('report/customer/index') ; ?>
    </div>
