...
$amntdate = ''; $amnt = '' ; $tamnt = 0 ;
    if($type == 1){       
       echo $this->element('/report/product/daily');
    }elseif($type == 2){
        //echo "In progress";
       echo $this->element('/report/product/weekly'); 
    }elseif($type == 3){
       echo $this->element('/report/product/monthly'); 
    }elseif($type == 4){
       echo $this->element('/report/product/yearly'); 
    }elseif($type == 5){
       echo $this->element('/report/product/life_time'); 
    } 
...
<div class="row">
    <div class="col-lg-12">
        ...
        <?php echo $this->Form->create('Report', array('url' => array('controller' => 'reports', 'action' => 'productReport','id'=>'one')));  ?>
	...
	<?php echo $this->Form->input('Item.id',array('type'=>'select','class'=>'form-control valid','label'=>false,'div'=>false,'autocomplete' => 'off','options'=>$categoryList,'empty'=>'Item name')); ?>		
                ...
                <div class="col-lg-1">	
                    <label>&nbsp;&nbsp;&nbsp;&nbsp;</label>
                    <?php echo $this->Html->link('Download Excel', array('controller'=>'reports','action'=>'productReportDownload',$type,$startdate,$enddate,$Month,$Year,$yearFrom,$yearTo,$item),array('class' => 'btn btn-default')); ?>
                </div>
           </div></div>
        <?php echo $this->Form->end();?>
          ...
          <?php  echo  $this->element('report/product/index') ; ?>
    </div>
</div>
