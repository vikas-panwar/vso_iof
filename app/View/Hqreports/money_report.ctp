...
$tamnt = 0;
if ($type == 1) {
    echo $this->element('/hqreport/dollar/daily');
} elseif ($type == 2) {
    //echo "In progress";
    echo $this->element('/hqreport/dollar/weekly');
} elseif ($type == 3) {
    echo $this->element('/hqreport/dollar/monthly');
} elseif ($type == 4) {
    echo $this->element('/hqreport/dollar/yearly');
} elseif ($type == 5) {
    echo $this->element('/hqreport/dollar/life_time');
}
...
<div class="row">
    <div class="col-lg-12">
        ...
        <?php echo $this->Form->create('Report', array('url' => array('controller' => 'hqreports', 'action' => 'moneyReport', 'id' => 'one'))); ?>
        <div class="row">
            <div class="col-lg-6">
                <label>Store</label>
                <?php
        ...
        <div class="row padding_btm_20">
            ...
            <div style="float:right;">
                <div class="col-lg-1">	
                    ...
                    echo $this->Html->link('Download Excel', array('controller' => 'hqreports', 'action' => 'moneyReportDownload', $storeId,$type, $startdate, $enddate, $Month, $Year, $yearFrom, $yearTo, $ordertype), array('class' => 'btn btn-default downLoad '.$hidden)); ?>
                </div>
            </div></div>
        ...
        <br><br>
        <?php echo $this->element('hqreport/dollar/index'); ?>
    </div>
</div>
