...
$tamnt = 0;
if ($type == 1) {
    echo $this->element('/hqreport/customer/daily');
} elseif ($type == 2) {
    //echo "In progress";
    echo $this->element('/hqreport/customer/weekly');
} elseif ($type == 3) {
    echo $this->element('/hqreport/customer/monthly');
} elseif ($type == 4) {
    echo $this->element('/hqreport/customer/yearly');
} elseif ($type == 5) {
    echo $this->element('/hqreport/customer/life_time');
}
...
<div class="row">
    <div class="col-lg-12">
        ...
        <?php echo $this->Form->create('Report', array('url' => array('controller' => 'hqreports', 'action' => 'customerReport', 'id' => 'one'))); ?>
        <div class="row">
            <div class="col-lg-6">
                <label>Store</label>
                <?php
            ...
            <div style="float:right;">
                <div class="col-lg-1">	
                    ...
                    <?php if(!empty($storeId)){
                        ...
                        $storeId='All';
                        $hidden = "";
                    } echo $this->Html->link('Download Excel', array('controller' => 'hqreports', 'action' => 'customerReportDownload', $storeId,$type, $startdate, $enddate, $Month, $Year, $yearFrom, $yearTo), array('class' => 'btn btn-default downLoad '.$hidden)); ?>
                </div>
            </div></div>
        ...
        <?php echo $this->element('hqreport/customer/index'); ?>
    </div>
