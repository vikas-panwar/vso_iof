...
$amntdate = ''; $amnt = '' ; $tamnt = 0 ;
    if($type == 1){       
       echo $this->element('/hqreport/order/daily');
    }elseif($type == 2){
        //echo "In progress";
       echo $this->element('/hqreport/order/weekly'); 
    }elseif($type == 3){
       echo $this->element('/hqreport/order/monthly'); 
    }elseif($type == 4){
       echo $this->element('/hqreport/order/yearly'); 
    }elseif($type == 5){
       echo $this->element('/hqreport/order/life_time'); 
    } 
...
<div class="row">
    <div class="col-lg-12">
        ...
        <?php echo $this->Form->create('Report', array('url' => array('controller' => 'hqreports', 'action' => 'orderReport','id'=>'one')));  ?>
        <div class="row">
            <div class="col-lg-6">
                <label>Store</label>
                <?php
	...
	<?php echo $this->Form->input('Segment.id',array('type'=>'select','class'=>'form-control valid','label'=>false,'div'=>false,'autocomplete' => 'off','options'=>$typeList,'empty'=>'Order Type')); ?>		
                ...
                <div class="col-lg-1">	
                    ...
                    echo $this->Html->link('Download Excel', array('controller'=>'hqreports','action'=>'orderReportDownload',$storeId,$type,$startdate,$enddate,$Month,$Year,$yearFrom,$yearTo,$ordertype),array('class' => 'btn btn-default downLoad '.$hidden)); ?>
                </div>
           </div></div>
        <?php echo $this->Form->end();?>
          ...
          <br><br>
          <?php  echo  $this->element('hqreport/order/index') ; ?>
    </div>
</div>
