...
<div class="row">
    ...
    <div class="col-lg-6">
                <?php echo $this->Html->link('Back', "/hqcategories/index/", array("class" => "btn btn-default",'escape' => false)); ?>   
            </div>
...
<br>
      <div class="row">      
            <?php echo $this->Form->create('Category', array('url'=>array('controller'=>'hqcategories','action'=> 'uploadfile'),"id" => "addfrm",'enctype'=>'multipart/form-data'));  ?>
    <div class="col-lg-6">
<!--        <div class="form-group form_margin" style="display: none">-->
            ...
            echo $this->Form->input('Category.store_id', array('options' => @$merchantList, 'class' => 'form-control', 'label' => false, 'div' => false, 'empty' => 'Select Store'));
            ?>
            </div>
        </div>
...
<!--	<div class="form-group form_margin" style="display: none">	-->
            ...
            <?php echo $this->Html->link('Cancel', "/hqcategories/index/", array("class" => "btn btn-default",'escape' => false)); ?>
        </div>
...
<!--    <div class="col-lg-6" style="display: none">      -->
         <div class="sampleDownload" style="display: none">      
                <div class="addbutton"> 
                     ...
                     <?php echo $this->Form->button('Sample Download', array('type' => 'button','class' => 'btn btn-default downloadcategory')); ?>
<!--                    <a href="/file_upload_format/Size_Sample_Excel.xls">Sample Download</a>-->
   ...
   <script type="text/javascript">
    ...
    $(function(){
      ...
      $('#CategoryStoreId').on('change', function () {
          var storeid = $(this).val(); // get selected value
         $('.downloadcategory').on('click', function () { // require a URL
                  url='/hqcategories/downloadcategory';
