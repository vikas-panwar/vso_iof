...
<div class="row">
    <div class="col-sm-12">
        <h3>Share Extended Offer</h3><br>
        <?php echo $this->Session->flash(); ?>
        <div class="row padding_btm_20">
            <div class="form-group">
                <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Store Name :<span class="required">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $itemOfferData['Store']['store_name']; ?> </span></label>
            </div>
        </div>
        <div class="table-responsive">
            <?php echo $this->element('show_pagination_count'); ?>
            <?php echo $this->Form->create('Offer', array('url' => array('controller' => 'hqitemoffers', 'action' => 'shareExtendedOffer'), 'id' => 'AdminId', 'type' => 'post')); ?>

            <?php echo $this->Form->input('User.extended_offer_id', array('type' => 'hidden', 'value' => $itemOfferData['ItemOffer']['id'])); ?>
