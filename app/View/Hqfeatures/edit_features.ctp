...
<div class="row">        
    ...
    <div class="col-lg-6">            
        ...
        <?php echo $this->Html->link('Cancel', "/hqfeatures/index", array("class" => "btn btn-default", 'escape' => false)); ?>
    </div>
                    ...
                    if (!empty($list)) {
                        ...
                        foreach ($list as $key => $data) {
                            ...
                            <tr <?php echo $class; ?> notif-id="<?php echo $EncryptFeaturedItemID; ?>">	    
                                ...
                                <td>
                                    <?php echo $this->Html->link($this->Html->image("store_admin/delete.png", array("alt" => "Delete", "title" => "Delete")), array('controller' => 'hqfeatures', 'action' => 'deleteFeaturedItem', $EncryptFeaturedItemID), array('confirm' => 'Are you sure to delete Item?', 'escape' => false)); ?>         
                                </td>
                            </tr>
                            <?php
                            $i++;
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('.addNewItem').click(function () {
            ...
            $.ajax({
                type: 'post',
                url: '/hqfeatures/addFeaturedItem',
        ...
        $(document).on('change', '#CategoryCategoryId', function () {
            ...
            $.ajax({
                type: 'post',
                url: '/hqfeatures/getItemByCategoryId',
