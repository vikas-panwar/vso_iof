<div class="row">
    <div class="col-lg-12">
        ...
        <div class="table-responsive">   
            <?php echo $this->Form->create('Item', array('url' => array('controller' => 'hqfeatures', 'action' => 'featuredItemList'), 'id' => 'AdminId', 'type' => 'post')); ?>
            <div class="row padding_btm_20">
                ...
                <div class="col-lg-1">		 
                    <?php echo $this->Html->link('Clear', array('controller' => 'hqfeatures', 'action' => 'featuredItemList', 'clear'), array('class' => 'btn btn-default')); ?>
                </div>
            </div>
...
<script>
    ...
    $(document).on('change', '#featured_check', function () {
        ...
        if (featuredId && item_id && store_id) {
            $.ajax({
                url: "<?php echo $this->Html->url(array('controller' => 'hqfeatures', 'action' => 'ajaxfeatureUpdate')); ?>",
                type: 'post',
                data: {featured_id: featuredId, item_id: item_id, status: status,store_id:store_id},
