...
<div class="row">
    ...
    <div class="col-lg-6">
                <?php echo $this->Html->link('Back', "/hqsubpreferences/index/", array("class" => "btn btn-default",'escape' => false)); ?>   
            </div>
...
<br>
      <div class="row">      
            <?php echo $this->Form->create('SubPreference', array('url'=>array('controller'=>'hqsubpreferences','action'=> 'uploadfile'),"id" => "addfrm",'enctype'=>'multipart/form-data'));  ?>
    <div class="col-lg-6">
