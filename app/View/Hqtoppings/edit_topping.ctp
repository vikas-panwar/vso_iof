    ...
    <div class="col-lg-6">
        ...
        <div class="form-group" id="ItemsDiv" <?php echo $display; ?> >
            ...
            <span id="ItemsBox" <?php echo $display; ?> >
                <?php
                echo $this->Form->input('Topping.item_id', array('type' => 'select', 'class' => 'form-control valid', 'label' => false, 'div' => false, 'autocomplete' => 'off', 'options' => $itemList));
                ?>
            </span>
        </div>
    ...
    $(document).ready(function () {
        ...
        $("#CategoryId").change(function () {
            ...
            if (catgoryId && storeId) {
                $.ajax({url: "/hqtoppings/itemsByCategoryId/" + catgoryId + "/" + storeId, success: function (result) {
                        $("#ItemsDiv").show();
                        $("#ItemsBox").show();
