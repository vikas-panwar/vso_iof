...
<div class="row">
    ...
    <div class="col-lg-6">
                <?php echo $this->Html->link('Back', "/hqtoppings/subTopping/", array("class" => "btn btn-default",'escape' => false)); ?>   
            </div>
...
<br>
      <div class="row">      
            <?php echo $this->Form->create('Topping', array('url'=>array('controller'=>'hqtoppings','action'=> 'upload_sub_topping_file'),"id" => "addfrm",'enctype'=>'multipart/form-data'));  ?>
    <div class="col-lg-6">
...
<!--    <div class="col-lg-6" style="display: none">      -->
         <div class="sampleDownload" style="display: none">      
                <div class="addbutton"> 
                     ...
                     <?php echo $this->Form->button('Sample Download', array('type' => 'button','class' => 'btn btn-default downloadsubtoppingfile')); ?>
   ...
   <script type="text/javascript">
    ...
    $(function(){
      ...
      $('#ToppingStoreId').on('change', function () {
         ...
         $('.downloadsubtoppingfile').on('click', function () { // require a URL
                  url='/hqtoppings/downloadsubtoppingfile';
