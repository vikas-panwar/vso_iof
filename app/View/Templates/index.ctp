    ...
    <div class="col-lg-7">
        ...
        <div class="table-responsive">   
            ...
            <div class="row padding_btm_20">
                ...
                <div class="col-lg-1">		  
                    <?php echo $this->Html->link('Clear', "/templates/index/clear", array("class" => "btn btn-default", 'escape' => false)); ?>
                </div>
                    ...
                    if ($list) {
                        ...
                        foreach ($list as $key => $data) {
                            ...
                            <tr <?php echo $class; ?>>	    
                                ...
                                <td>
                                    <?php echo $this->Dateform->us_format($this->Common->storeTimezone('', $data['EmailTemplate']['created'])); ?>
                                </td>
                                <td>
                                    <?php
