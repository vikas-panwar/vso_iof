...
<div class="row">        
    ...
    <div class="col-lg-6">            
        ...
        <div class="form-group form_margin">		 
            ...
            <?php
            echo $this->Form->input('EmailTemplate.template_subject', array('type' => 'text', 'class' => 'form-control valid', 'placeholder' => 'Enter Type', 'label' => '', 'div' => false));
        ...
        <div class="form-group form_spacing">
            ...
            <?php
            echo $this->Form->textarea('EmailTemplate.template_message', array('class' => 'ckeditor'));
...
<?php if ($this->request->data['EmailTemplate']['sms_template']) { ?>
            <div class="form-group form_spacing">
                ...
                <?php
                echo $this->Form->input('EmailTemplate.sms_template', array('type' => 'textarea', 'class' => 'form-control valid', 'placeholder' => 'Enter Message', 'label' => '', 'div' => false));
...
<script>
    ...
    var editor = CKEDITOR.replace('EmailTemplateTemplateMessage', {
