...
<div class="row">
            ...
            <div class="col-lg-6">                        
                <div class="addbutton"> 
                                        <?php echo $this->Form->button('Sample Download', array('type' => 'button','onclick'=>"window.location.href='/toppings/download'",'class' => 'btn btn-default')); ?>
<!--                    <a href="/file_upload_format/Add-on_Sample_Excel.xls">Sample Download</a>-->
                </div>
            </div>
    </div>   
<div class="row">        
            <?php echo $this->Form->create('Topping', array('url'=>array('controller'=>'toppings','action'=> 'uploadfile'),"id" => "addfrm",'enctype'=>'multipart/form-data'));  ?>
    <div class="col-lg-6">            
