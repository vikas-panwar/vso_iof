...
<div class="row">        
    ...
    <div class="col-lg-6">
        ...
        <div class="form-group form_margin hidden merchant-payment-date">
            <label>Payment Date<span class="required"> * </span></label>  
            <?php
            echo $this->Form->input('MerchantPayment.payment_date', array('type' => 'text', 'class' => 'form-control', 'div' => false, 'readonly' => true, 'Placeholder' => 'Select Payment Date'));
