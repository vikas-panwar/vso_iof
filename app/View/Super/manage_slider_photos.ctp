	 ...
	 <h3>Manage Slider Images</h3> 
	  ...
	  <div class="addbutton">                
		  ...
		  <label>Upload Image<span class="required"> * </span></label>    
               <?php
		  echo $this->Form->input('StoreGallery.image',array('type'=>'file','label'=>'','div'=>false,'class'=>'form-control','style'=>"box-sizing:initial;"));                  echo $this->Form->error('StoreGallery.image');
	       ?>
	        <span class="blue">(For best viewing upload images with minimum resolution 1100X500)</span> 
		     </div>
